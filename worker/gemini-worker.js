...
6) جدول قائمة بعمود "اليوم" حرفًا واحدًا: ح=الأحد، ن=الاثنين، ث=الثلاثاء، ر=الأربعاء، خ=الخميس، ج=الجمعة، س=السبت. ضع uncertain=true لهذه المحاضرات لأن الرموز تختلف بين الجامعات.
